...
// MARK: - Brutalist design tokens (redesign spec §2, §3)
//
// Color tokens (ampWhite, ampBlack, ampGreen, ampYellow, ampNavy, ampCream,
// ampMutedText, ampMutedTextStrong, ampInversionLabel, ampDivider) are
// auto-generated as static members on Color from the Asset Catalog — reference
// them as `.ampNavy` etc. directly. No extension needed here.
